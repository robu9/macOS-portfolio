...
const projects: Project[] = [
    {
        name: 'Snappy',
        link: 'https://heysnappy.tech',
        desc: 'A desktop AI companion that lives by your cursor — it sees your screen, answers by voice, points at UI elements, and runs background agents for research and automation.',
        stack: ['Electron', 'TypeScript', 'Cloudflare Workers', 'Voice AI'],
    },
    {
